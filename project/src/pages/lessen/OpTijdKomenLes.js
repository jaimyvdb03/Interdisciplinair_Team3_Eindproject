...
function renderStep(step, s, tc) {
  ...
  if (step === 1) {
    return (
      <div className="bg-white rounded-2xl p-4 shadow-sm">
        <h2 className="text-[17px] font-bold text-gray-900 mb-3">{s.s1.sectionTitle}</h2>
  ...
  if (step === 2) {
    ...
    return (
      <div className="bg-white rounded-2xl p-4 shadow-sm">
        <h2 className="text-[17px] font-bold text-gray-900 mb-3">{s.s2.sectionTitle}</h2>
        <div className="flex items-center justify-between mb-2">
  ...
  if (step === 4) {
    return (
      <div className="bg-white rounded-2xl p-4 shadow-sm">
        <h2 className="text-[17px] font-bold text-gray-900 mb-3">{s.s4.sectionTitle}</h2>
        <div className="flex items-center justify-between mb-2">
